    ...
    <footer className="bg-tech-dark text-white/80 pt-16 pb-8">
      <div className="container mx-auto px-4">
          ...
          <div>
            <div className="mb-4">
              ...
              <p className="text-sm italic text-white/60">
                Where Innovation Creates Ripples of Change
              </p>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              {[1, 2, 3, 4].map((item) => (
                <a
                  key={item}
                  href="#"
                  className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-devatro-blue/50 transition-colors"
                >
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item}>
                  <a
                    href="#"
                    className="hover:text-devatro-blue transition-colors"
                  >
                    {item}
                  </a>
                </li>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">&copy; {year} Devatro. All rights reserved.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a
              href="#"
              className="text-sm hover:text-devatro-blue transition-colors"
            >
              Privacy Policy
            </a>
            <a
